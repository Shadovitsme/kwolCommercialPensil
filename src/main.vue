    ...
    <div class="flex md:justify-between md:mx-auto max-w-[1920px] z-20">
      <div class="md:ml-[6.25rem] md:w-full">
        <div class="mt-10 md:w-[51.75rem] md:ml-5">
          <h1 class="H5 md:H1 Text uppercase text-justify">Бриф, подготовленный</h1>
          <h1 class="speciall text-justify text-[40px] md:text-[104px] mb-6">специально для вас</h1>
        </div>
        <p
          class="md:p3 p4 h-12 Text min-[6.25rem]:mt-4 laptop:mt-5 mb-[3.125rem] md:mb-[4rem] md:ml-5 tracking-tighter"
        >
        ...
        <div class="md:p-[3.75rem] p-5 md:ml-1 border-[1px] border-[#E4A85E] rounded-[0.625rem]">
          <h class="md:H3 H5 Text uppercase"> Основные данные</h>
