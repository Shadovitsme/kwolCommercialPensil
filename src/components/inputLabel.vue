...
<template>
  ...
  >
    <input class="md:mr-5 rounded-[5px] text-Text p3 w-full md:w-8/12 lg:w-full absolute md:static top-0 z-20 flex my-auto outline-none placeholder:p3 placeholder:text-QuietText pl-4 py-3 border-[1px] border-Accent bg-DarkAccent labelWrapper  overflow-hidden h-fit  " placeholder="Название" />
    <div
